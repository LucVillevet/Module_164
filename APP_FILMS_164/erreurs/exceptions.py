...
class ExceptionDonneesAfficher(Base):
    pass


class ExceptionDonneesUpdate(Base):
    pass


class ExceptionDonneesAjouter(Base):
    pass


class ExceptionDonneesDelete(Base):
    pass


class ExceptionComptesAfficher(Base):
    pass


class ExceptionComptesUpdate(Base):
    pass


class ExceptionComptesAjouter(Base):
    pass


class ExceptionComptesDelete(Base):
    pass


class ExceptionLieuAfficher(Base):
    pass


class ExceptionLieuUpdate(Base):
    pass


class ExceptionLieuAjouter(Base):
    pass


class ExceptionLieuDelete(Base):
    pass


class ExceptionTypeAfficher(Base):
    pass


class ExceptionTypeUpdate(Base):
    pass


class ExceptionTypeAjouter(Base):
    pass


class ExceptionTypeDelete(Base):
    pass


class ExceptionDonneesAfficherData(Base):
    pass
